    ...
    2: [
      function (e, t, n) {
        ...
        function i(e, t) {
          function n(e, t, n, i) {
            e.addEventListener
              ? e[n ? "addEventListener" : "removeEventListener"](t, i)
              : e[n ? "attachEvent" : "detachEvent"]("on" + t, i);
          }
          function i() {
          ...
          return e.nodeName
            ? "img" !== e.nodeName.toLowerCase()
              ...
              : (n(e, "load", !0, i),
                n(e, "error", !0, i),
                void (
                  (e.readyState || e.complete) &&
                  ((o = e.src), (e.src = r), (e.src = o))
                ))
          ...
          r = {
            getImageSrcs: function (e) {
              if (
                ((this.sources = []),
                "undefined" != typeof e &&
                  (this.findImageInElement(e), this.deepSearch === !0))
              )
            ...
            determineUrlAndType: function (e) {
              ...
              return (
                ("undefined" != typeof i.backgroundImage &&
                  "" !== i.backgroundImage &&
                  "none" !== i.backgroundImage) ||
                ("undefined" != typeof e.style.backgroundImage &&
                  "" !== e.style.backgroundImage &&
                  "none" !== e.style.backgroundImage)
                  ? ((t = i.backgroundImage || e.style.backgroundImage),
                    (n = "background"))
                  : "img" === e.nodeName.toLowerCase() && (t = e.src),
                { url: t, type: n }
              );
            },
            hasGradient: function (e) {
              return e && "undefined" != typeof e.indexOf
          ...
          r = {
            ...
            applyStyling: function () {
              (this.element.style.height = "40px"),
                ...
                (this.element.style.position = "absolute"),
                (this.element.style.fontSize = "10em"),
                (this.element.style.top = "40%"),
                (this.element.style.left = "0"),
                (this.element.style.fontWeight = "bold"),
                (this.element.style.marginTop =
                  "-" + (59 + this.barHeight) + "px"),
            ...
            applyStyling: function () {
              (this.element.style.position = this.calculatePosition()),
                ...
                (this.element.style.OTransition =
                  "opacity " + this.fadeOutTime + "ms"),
                (this.element.style.MsTransition =
                  "opacity " + this.fadeOutTime + "ms"),
            ...
            calculatePosition: function () {
              ...
              return (
                "body" === this.parentElement.tagName.toLowerCase()
                  ? (e = "fixed")
                  : ("fixed" === this.parentElement.style.position &&
                      "absolute" === this.parentElement.style.position) ||
            ...
            updateProgress: function (e, t) {
              null !== this.loadingBar && this.loadingBar.updateProgress(e, t),
                null !== this.percentage &&
                  this.percentage.updateProgress(e, t);
            },
            remove: function () {
              this.canRemove(this.element) &&
                this.element.parentNode.removeChild(this.element);
            },
            canRemove: function (e) {
              return (
                e.parentNode && "undefined" != typeof e.parentNode.removeChild
              );
            },
          };
        t.exports = function (e) {
      ...
      function (e, t, n) {
        ...
        t.exports = function () {
          var e = window.setInterval(function () {
            if (
              "undefined" != typeof document.getElementsByTagName("body")[0]
            ) {
            ...
            updateProgress: function (e, t) {
              ...
              this.overlay.updateProgress(n, this.options.minimumTime),
                "function" == typeof this.options.onProgress &&
                  this.options.onProgress(n, e, t),
                e === t &&
                  this.done === !1 &&
                  (window.clearTimeout(this.maxTimeout),
                  window.setTimeout(
                    this.doneLoading.bind(this),
                    this.options.minimumTime
                  ));
            },
